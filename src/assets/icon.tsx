  ...
  switch (name) {
    ...
    case "myProfile":
      return (
        ...
        >
          <path
            d="M11.5 11.3334C14.0313 11.3334 16.0834 9.28139 16.0834 6.75008C16.0834 4.21878 14.0313 2.16675 11.5 2.16675C8.96872 2.16675 6.91669 4.21878 6.91669 6.75008C6.91669 9.28139 8.96872 11.3334 11.5 11.3334Z"
            stroke="#6A6A6A"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M19.3742 20.5002C19.3742 16.9527 15.845 14.0835 11.5 14.0835C7.15503 14.0835 3.62585 16.9527 3.62585 20.5002"
            stroke="#6A6A6A"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
